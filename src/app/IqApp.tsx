...
const LEGAL_DOCS: Record<'privacy' | 'terms', { title: string; lede: string; sections: Array<{ heading: string; body: string }> }> = {
  privacy: {
    ...
    sections: [
      ...
      { heading: 'How we use data', body: 'We use data to operate the game, calculate scores, maintain leaderboards and friend rooms, generate profile links, prevent abuse, process subscriptions through Recursiv and Stripe, provide support, improve product quality, show configured ads or sponsorships, and comply with legal obligations.' },
      { heading: 'Cookies, local storage, analytics, and ads', body: 'IQ WARS uses cookies and local storage for login, daily attempt limits, settings, sound preferences, room links, paid access, and security. Analytics are optional in Settings where available. If advertising is enabled, ad partners may process device, page, and interaction signals under their own policies; we will provide required privacy-choice controls where applicable.' },
      { heading: 'Sharing', body: 'Public profile links and leaderboard entries show the fields you choose to make public. Payment data is processed by Stripe through Recursiv billing. Infrastructure, email, analytics, advertising, and AI providers may process data as subprocessors or service providers. We do not sell personal data for money.' },
      { heading: 'AI and inference', body: 'IQ WARS may use AI or automated systems to infer coarse geography, detect abuse, classify aggregate activity, improve puzzle and profile quality, and support agents or benchmarks when disclosed. These inferences are not required to play, are not used for high-stakes eligibility decisions, and can be limited through settings where available.' },
      { heading: 'Privacy choices and rights', body: 'Depending on where you live, you may have rights to know, access, delete, correct, export, opt out of certain sharing or targeted advertising, limit certain sensitive uses, and avoid discrimination for exercising privacy rights. Send requests to bill@recursiv.io. If Global Privacy Control or a similar legally recognized browser signal applies to IQ WARS, we will treat it as an opt-out where required.' },
      ...
      { heading: 'International users', body: 'IQ WARS is operated from the United States. If you use the service from another country, your information may be processed in the United States and other locations where Recursiv, Stripe, email, infrastructure, analytics, advertising, or AI providers operate.' },
  ...
  terms: {
    ...
    sections: [
      ...
      { heading: 'Billing, cancellation, and refunds', body: `Free players get one full official IQ WARS run per day. Paid features, currently listed at ${UNLIMITED_PRICE_LABEL} unless changed in product, are billed through Recursiv and Stripe. You can manage or cancel paid access through the billing flow made available by Recursiv or by contacting bill@recursiv.io. Fees are non-refundable except where required by law or expressly stated.` },
      { heading: 'Third-party services', body: 'Optional X verification, payment processing, email, analytics, advertising, hosting, AI, and anti-abuse services depend on third parties. Their availability and terms may apply. Recursiv is not responsible for third-party outages or decisions.' },
      { heading: 'Agents and automation', body: 'Automated or agent play must be disclosed and may be separated from human leaderboards. Private friend rooms are intended for real invited people unless the room owner and product policy explicitly allow otherwise.' },
      { heading: 'Ads and sponsored content', body: 'IQ WARS may display advertising or sponsorship placements when configured. Ads do not change official scoring rules, and paid promotion does not guarantee rankings, scores, or leaderboard placement.' },
