...
const SEEDED_AGENT_PROFILES = [
  { id: 'agent-euclid', displayName: 'Mina Vale', username: 'mina_vale', score: 142, rank: '#8,210', percentile: 99.2, correct: 11, elapsedMs: 424_000, beatAi: 4, geo: { country: 'United States', countryCode: 'US', region: 'New York', city: 'New York', town: 'New York', timeZone: 'America/New_York', source: 'agent_seed' } },
  { id: 'agent-noether', displayName: 'Theo Park', username: 'theo_park', score: 139, rank: '#12,480', percentile: 98.8, correct: 10, elapsedMs: 382_000, beatAi: 3, geo: { country: 'Germany', countryCode: 'DE', region: 'Berlin', city: 'Berlin', town: 'Berlin', timeZone: 'Europe/Berlin', source: 'agent_seed' } },
  { id: 'agent-turing', displayName: 'Lina Ortiz', username: 'lina_ortiz', score: 136, rank: '#19,300', percentile: 98.1, correct: 10, elapsedMs: 441_000, beatAi: 3, geo: { country: 'United Kingdom', countryCode: 'GB', region: 'England', city: 'London', town: 'London', timeZone: 'Europe/London', source: 'agent_seed' } },
  { id: 'agent-ramanujan', displayName: 'Amir Rao', username: 'amir_rao', score: 134, rank: '#25,900', percentile: 97.4, correct: 10, elapsedMs: 506_000, beatAi: 2, geo: { country: 'India', countryCode: 'IN', region: 'Tamil Nadu', city: 'Chennai', town: 'Chennai', timeZone: 'Asia/Kolkata', source: 'agent_seed' } },
  { id: 'agent-hypatia', displayName: 'Clara Novak', username: 'clara_novak', score: 131, rank: '#38,400', percentile: 96.2, correct: 9, elapsedMs: 365_000, beatAi: 3, geo: { country: 'Egypt', countryCode: 'EG', region: 'Alexandria', city: 'Alexandria', town: 'Alexandria', timeZone: 'Africa/Cairo', source: 'agent_seed' } },
  { id: 'agent-curie', displayName: 'Sofia Mensah', username: 'sofia_m', score: 128, rank: '#54,100', percentile: 94.6, correct: 9, elapsedMs: 458_000, beatAi: 2, geo: { country: 'France', countryCode: 'FR', region: 'Ile-de-France', city: 'Paris', town: 'Paris', timeZone: 'Europe/Paris', source: 'agent_seed' } },
  { id: 'agent-lovelace', displayName: 'Owen Li', username: 'owen_li', score: 126, rank: '#71,600', percentile: 92.8, correct: 9, elapsedMs: 533_000, beatAi: 2, geo: { country: 'United States', countryCode: 'US', region: 'California', city: 'San Francisco', town: 'San Francisco', timeZone: 'America/Los_Angeles', source: 'agent_seed' } },
  { id: 'agent-gauss', displayName: 'Maya Chen', username: 'maya_chen', score: 123, rank: '#93,200', percentile: 90.7, correct: 8, elapsedMs: 401_000, beatAi: 2, geo: { country: 'Canada', countryCode: 'CA', region: 'Ontario', city: 'Toronto', town: 'Toronto', timeZone: 'America/Toronto', source: 'agent_seed' } },
  { id: 'agent-wu', displayName: 'Niko Adler', username: 'niko_adler', score: 121, rank: '#111,900', percentile: 88.8, correct: 8, elapsedMs: 489_000, beatAi: 1, geo: { country: 'Singapore', countryCode: 'SG', region: null, city: 'Singapore', town: 'Singapore', timeZone: 'Asia/Singapore', source: 'agent_seed' } },
  { id: 'agent-feynman', displayName: 'Yara Singh', username: 'yara_singh', score: 118, rank: '#142,000', percentile: 85.8, correct: 8, elapsedMs: 557_000, beatAi: 1, geo: { country: 'Australia', countryCode: 'AU', region: 'New South Wales', city: 'Sydney', town: 'Sydney', timeZone: 'Australia/Sydney', source: 'agent_seed' } },
